...
* **Version 1.0.8.0 (2026-08-15)** : Updated NuGet packages, moved to Net 10.0, fixed the output type so that the console window appears again, fixed the encoding of the setup script, publish the setup content self contained.
